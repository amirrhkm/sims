    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8 ml-64 w-full">
            <div class="max-w-2xl mx-auto">
                <!-- Header -->
                <div class="mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">Kemaskini Pengguna</h2>
                </div>

                <!-- Form -->
                <form action="{{ route('pengurus.pengguna-edit', $user->id) }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <!-- Password -->
                    <div class="mb-4">
                        <label for="password" class="block text-gray-700 text-sm font-bold mb-2">Kata Laluan Baru (Kosongkan jika tiada perubahan)</label>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="role" id="role" 
                            ...
                            <option value="pengurus" {{ $user->role === 'pengurus' ? 'selected' : '' }}>Pentadbir</option>
                        </select>
                    </div>
                    ...
                    <!-- Section Dropdown -->
                    <!-- <div class="mb-4">
                        <label for="section" class="block text-gray-700 text-sm font-bold mb-2">Seksyen/Unit</label>
