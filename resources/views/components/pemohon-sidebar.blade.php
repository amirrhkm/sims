<div class="fixed h-screen w-64 bg-gray-900 text-white flex flex-col transition-all duration-300">
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <a href="{{ route('pemohon.laporan', Auth::user()->id) }}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-800 transition-all duration-200 {{ request()->routeIs('pemohon.laporan') ? 'bg-blue-600 bg-opacity-50' : '' }}">
            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
