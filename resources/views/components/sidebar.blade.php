<div class="min-h-screen w-64 bg-gray-900 text-white flex flex-col transition-all duration-300">
    ...
    <nav class="flex-1 p-4 space-y-2">
        ...
        <a href="" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-800 transition-all duration-200 {{ request()->routeIs('borang-permohonan') ? 'bg-blue-600' : '' }}">
            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-800 transition-all duration-200 {{ request()->routeIs('inventori') ? 'bg-blue-600' : '' }}">
            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
